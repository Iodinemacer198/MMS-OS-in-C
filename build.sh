...
gcc -m32 -ffreestanding -Ikernel/fs -Ikernel/commands -Ikernel/commands/calc -Ikernel/commands/login -Ikernel/commands/wordle -c kernel/kernel.c -o iso/build/kernel.o -O2 -Wall
...
iso/build/boot.o iso/build/kernel.o iso/build/ata.o iso/build/fs.o iso/build/calc.o iso/build/login.o iso/build/wordle.o
