...
gcc -m32 -ffreestanding -Ikernel/fs -Ikernel/commands -Ikernel/io -Ikernel/commands/calc -Ikernel/commands/login -Ikernel/commands/wordle -Ikernel/fatfs -c kernel/kernel.c -o iso/build/kernel.o -O2 -Wall
...
gcc -m32 -ffreestanding -Ikernel/io -c kernel/fatfs/diskio.c -o iso/build/diskio.o -O2 -Wall
gcc -m32 -ffreestanding -c kernel/fatfs/ff.c -o iso/build/ff.o -O2 -Wall
...
iso/build/boot.o iso/build/kernel.o iso/build/ata.o iso/build/fs.o iso/build/calc.o iso/build/login.o iso/build/wordle.o iso/build/diskio.o iso/build/ff.o 
